        ...
        <div className="mb-12 p-6 bg-slate-800/50 rounded-2xl backdrop-blur-sm border border-slate-700/50">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {chargingStations.map((station) => (
              <div key={station.location} className="bg-slate-700/50 rounded-lg p-4 hover:bg-slate-700/70 transition-all duration-300 hover:scale-105">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <p className="text-gray-300 leading-relaxed">
              Revolutionizing electric vehicle infrastructure across Rwanda and beyond. We're building the future of sustainable transportation with smart charging solutions, renewable energy integration, and cutting-edge technology.
            </p>
