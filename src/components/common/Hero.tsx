  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-30">
        <div className="absolute inset-0 bg-gradient-to-r from-blue-600/20 via-purple-600/20 to-green-600/20 animate-gradient-x"></div>
      </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className={`mt-12 sm:mt-16 grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 transform transition-all duration-1000 delay-1000 ${
            ...
            <div className="text-center group hover:scale-110 transition-transform duration-200">
              <div className="text-2xl sm:text-3xl font-bold text-transparent bg-gradient-to-r from-blue-400 to-green-400 bg-clip-text mb-2 group-hover:animate-pulse">1000+</div>
              <div className="text-sm sm:text-base text-gray-300">Chargers Installed</div>
            </div>
            <div className="text-center group hover:scale-110 transition-transform duration-200">
              <div className="text-2xl sm:text-3xl font-bold text-transparent bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text mb-2 group-hover:animate-pulse">24/7</div>
              <div className="text-sm sm:text-base text-gray-300">Customer Support</div>
            </div>
            <div className="text-center group hover:scale-110 transition-transform duration-200">
              <div className="text-2xl sm:text-3xl font-bold text-transparent bg-gradient-to-r from-green-400 to-purple-400 bg-clip-text mb-2 group-hover:animate-pulse">99%</div>
