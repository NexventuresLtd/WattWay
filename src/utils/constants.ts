...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    description: 'Whether you need a compact home charger or a powerful commercial unit, WattWay supplies quality chargers with the latest features — from Wi-Fi control to RFID access.',
    image: 'https://www.hjlcharger.com/uploadfile/202307/3799b225414b.jpg'
  },
  {
    id: 'consultation',
    title: 'EV Industry Consultation',
    description: 'WattWay offers expert consulting services across the electric vehicle sector — helping you make informed, future-ready decisions.',
    features: [
  ...
  },
  {
    ...
    description: 'From small private setups to large public charging hubs, WattWay provides comprehensive design and implementation services.',
    process: [
...
export const TESTIMONIALS: Testimonial[] = [
  {
    id: 't1',
    quote: 'WattWay guided our company through the transition to electric vehicles — from selecting the right chargers to planning an entire charging hub.',
    author: 'Joseph M.',
    position: 'Kigali'
  },
  {
